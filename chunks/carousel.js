import { d as E, L as H, j as m, s as l, E as c, x as d, h as A } from "./iframe.js";
import { n as b } from "./ref.js";
import { c as F } from "./repeat.js";
import { m as L, d as M, b as v, g as U } from "./dom.js";
...
class Z extends H {
  constructor() {
    ...
    }, this.direction = "standby", this.items = [], this.maxItems = g.xxsmall, this.playing = !1, this.slideDurationRemaining = 1, this.suspendedDueToFocus = !1, this.suspendedDueToHover = !1, this.suspendedSlideDurationRemaining = 1, this.userPreventsSuspend = !1, this.arrowType = "inline", this.autoplay = !1, this.autoplayDuration = V, this.controlOverlay = !1, this.disabled = !1, this.messages = q(), this.calciteCarouselChange = m({ cancelable: !1 }), this.calciteCarouselPause = m({ cancelable: !1 }), this.calciteCarouselPlay = m({ cancelable: !1 }), this.calciteCarouselResume = m({ cancelable: !1 }), this.calciteCarouselStop = m({ cancelable: !1 });
  }
  static {
  ...
  renderRotationControl() {
    ...
    return d`<button .ariaLabel=${e} class=${l({
      [a.paginationItem]: !0,
      [a.autoplayControl]: !0
    })} @click=${this.toggleRotation} title=${e ?? c}><calcite-icon .icon=${this.playing ? h.pause : h.play} scale=s></calcite-icon>${this.playing && d`<calcite-progress class=${l(a.autoplayProgress)} .label=${this.messages.carouselItemProgress} .value=${t}></calcite-progress>` || ""}</button>`;
  }
  ...
  renderPaginationItems() {
    ...
    return d`<div .ariaLabel=${r} class=${l(a.paginationItems)} role=tablist>${F(i, (o) => o.id, (o, n) => {
      const p = i.length, u = n === e, S = n === 0, P = n === p - 1, I = p - t - 1, f = e < t, k = e >= I, x = f ? 0 : e - Math.floor(t / 2), T = k ? p : x + t, w = f ? 0 : k ? I : x, D = f ? t + 1 : T, O = !S && !P && !u && (n === w - 1 || n === D), $ = u || n <= D && n >= w - 1, C = p - 1 <= t, z = u ? h.active : h.inactive;
      return d`<button aria-controls=${(u ? void 0 : o.id) ?? c} .ariaSelected=${u} class=${l({
        ...
        [a.paginationItemRangeEdge]: p - 1 > t && O,
  ...
  renderArrow(e) {
    const t = e === "previous", i = U(this.el), r = this.arrowType === "edge" ? "m" : "s", s = t ? a.pagePrevious : a.pageNext, o = t ? this.messages.previous : this.messages.next, n = t ? h.chevronLeft : h.chevronRight;
  ...
  render() {
    ...
    return j({ disabled: this.disabled, children: d`<div .ariaLabel=${this.label} .ariaLive=${this.playing ? "off" : "polite"} .ariaRoleDescription=${this.messages.carousel} class=${l({
      [a.container]: !0,
      [a.containerOverlaid]: this.controlOverlay,

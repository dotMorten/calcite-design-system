import { d as k, L as f, s as d, x as z, E as r, c as p, h as C } from "./iframe.js";
import { i as x } from "./keyed.js";
import { b as y, h as m } from "./utils4.js";
import { o as b } from "./dom.js";
...
class q extends f {
  ...
  renderSwatchRect({ clipPath: e, fill: c, height: s, key: o, rx: w, stroke: h, strokeWidth: l, width: t }) {
    return x(o, p`<rect clip-path=${e ?? r} fill=${c ?? r} height=${s ?? r} rx=${w ?? r} stroke=${h ?? r} stroke-width=${l ?? r} width=${t ?? r} />`);
  }
}

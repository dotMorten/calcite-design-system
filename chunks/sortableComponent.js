...
function C(t, e, n, o, r) {
  if (!(!t.getBoundingClientRect && t !== window)) {
    var i, a, l, s, u, c, d;
    if (t !== window && t.parentNode && t !== L() ? (i = t.getBoundingClientRect(), a = i.top, l = i.left, s = i.bottom, u = i.right, c = i.height, d = i.width) : (a = 0, l = 0, s = window.innerHeight, u = window.innerWidth, c = window.innerHeight, d = window.innerWidth), (e || n) && t !== window && (r = r || t.parentNode, !V))
      do
  ...
  return {
    ...
    animateAll: function(o) {
      ...
      t.forEach(function(l) {
        var s = 0, u = l.target, c = u.fromRect, d = C(u), b = u.prevFromRect, y = u.prevToRect, E = l.rect, w = de(u, !0);
        w && (d.top -= w.f, d.left -= w.e), u.toRect = d, u.thisAnimationDuration && je(b, d) && !je(c, d) && // Make sure animatingRect is on line between toRect & fromRect
        (E.top - d.top) / (E.left - d.left) === (c.top - d.top) / (c.left - d.left) && (s = jt(E, b, y, r.options)), je(d, c) || (u.prevFromRect = c, u.prevToRect = d, s || (s = r.options.animation), r.animate(u, E, d, s)), s && (i = !0, a = Math.max(a, s), clearTimeout(u.animationResetTimer), u.animationResetTimer = setTimeout(function() {
...
function $t(t) {
  var e = t.sortable, n = t.rootEl, o = t.name, r = t.targetEl, i = t.cloneEl, a = t.toEl, l = t.fromEl, s = t.oldIndex, u = t.newIndex, c = t.oldDraggableIndex, d = t.newDraggableIndex, b = t.originalEvent, y = t.putSortable, E = t.extraEventProperties;
  if (e = e || n && n[N], !!e) {
    var w, k = e.options, j = "on" + o.charAt(0).toUpperCase() + o.substr(1);
    window.CustomEvent && !V && !Ce ? w = new CustomEvent(o, {
      bubbles: !0,
      cancelable: !0
    }) : (w = document.createEvent("Event"), w.initEvent(o, !0, !0)), w.to = a || n, w.from = l || n, w.item = r || n, w.clone = i, w.oldIndex = s, w.newIndex = u, w.oldDraggableIndex = c, w.newDraggableIndex = d, w.originalEvent = b, w.pullMode = y ? y.lastPutMode : void 0;
...
var f, S, g, D, ae, Fe, _, J, fe, X, _e, Q, Ae, I, ue = !1, Be = !1, Ge = [], re, G, Ue, qe, gt, mt, be, se, Se, Te = !1, Pe = !1, Re, O, Ve = [], et = !1, He = [], Le = typeof document < "u", xe = it, vt = Ce || V ? "cssFloat" : "float", qt = Le && !Et && !it && "draggable" in document.createElement("div"), It = function() {
  ...
  return i && (l.display === "block" || l.display === "flex" || l.display === "table" || l.display === "grid" || u >= r && o[vt] === "none" || a && o[vt] === "none" && u + c > r) ? "vertical" : "horizontal";
}, Vt = function(e, n, o) {
...
p.prototype = /** @lends Sortable.prototype */
{
  ...
  _onTapStart: function(e) {
    if (e.cancelable) {
      ...
      if (an(o), !f && !(/mousedown|pointerdown/.test(a) && e.button !== 0 || r.disabled) && !u.isContentEditable && !(!this.nativeDraggable && ye && s && s.tagName.toUpperCase() === "SELECT") && (s = H(s, r.draggable, o, !1), !(s && s.animated) && Fe !== s)) {
        if (fe = Y(s), _e = Y(s, r.draggable), typeof c == "function") {
  ...
  _onTouchMove: function(e) {
    if (re) {
      var n = this.options, o = n.fallbackTolerance, r = n.fallbackOffset, i = e.touches ? e.touches[0] : e, a = g && de(g, !0), l = g && a && a.a, s = g && a && a.d, u = xe && O && pt(O), c = (i.clientX - re.clientX + r.x) / (l || 1) + (u ? u[0] - Ve[0] : 0) / (l || 1), d = (i.clientY - re.clientY + r.y) / (s || 1) + (u ? u[1] - Ve[1] : 0) / (s || 1);
      if (!p.active && !ue) {
      ...
      if (g) {
        ...
        h(g, "webkitTransform", b), h(g, "mozTransform", b), h(g, "msTransform", b), h(g, "transform", b), Ue = c, qe = d, G = i;
      }
  ...
  _onDragOver: function(e) {
    var n = this.el, o = e.target, r, i, a, l = this.options, s = l.group, u = p.active, c = Ae === s, d = l.sort, b = I || u, y, E = this, w = !1;
    if (et) return;
    function k(ve, Ft) {
      x(ve, E, z({
        evt: e,
    ...
    function A(ve) {
      return k("dragOverCompleted", {
        insertion: ve
      }), ve && (c ? u._hideClone() : u._showClone(E), E !== b && (R(f, I ? I.options.ghostClass : u.options.ghostClass, !1), R(f, l.ghostClass, !0)), I !== E && E !== p.active ? I = E : E === p.active && I && (I = null), b === E && (E._ignoreWhileAnimating = o), E.animateAll(function() {
    ...
    if (f.contains(e.target) || o.animated && o.animatingX && o.animatingY || E._ignoreWhileAnimating === o)
      return A(!1);
    if (Be = !1, u && !l.disabled && (c ? d || (a = S !== D) : I === this || (this.lastPutMode = Ae.checkPull(this, u, f, e)) && s.checkPut(this, u, f, e))) {
...
function nn(t, e, n, o, r, i, a, l) {
  ...
  if (!a) {
    if (l && Re < u * r) {
      if (!Te && (Se === 1 ? s > c + u * i / 2 : s < d - u * i / 2) && (Te = !0), Te)
        b = !0;
...
var Je = _t(function(t, e, n, o) {
  if (e.scroll) {
    var r = (t.touches ? t.touches[0] : t).clientX, i = (t.touches ? t.touches[0] : t).clientY, a = e.scrollSensitivity, l = e.scrollSpeed, s = L(), u = !1, c;
    ...
    do {
      ...
      if (!T[d])
        for (var oe = 0; oe <= d; oe++)
          T[oe] || (T[oe] = {});
      (T[d].vx != ge || T[d].vy != $ || T[d].el !== y) && (T[d].el = y, T[d].vx = ge, T[d].vy = $, clearInterval(T[d].pid), (ge != 0 || $ != 0) && (u = !0, T[d].pid = setInterval(function() {
...
function hn(t) {
  if (Mt(t))
    return;
  un(t), ze.add(t);
  const e = "id", { group: n, handleSelector: o, dragSelector: r } = t;
  t.sortable = p.create(t.el, {
    ...
    ...!!n && {
      group: {
        name: n,
        ...!!t.canPull && {
          pull: (i, a, l, { newDraggableIndex: s, oldDraggableIndex: u }) => t.canPull({
            toEl: i.el,
            fromEl: a.el,
            dragEl: l,
            newIndex: s,
        ...
        ...!!t.canPut && {
          put: (i, a, l, { newDraggableIndex: s, oldDraggableIndex: u }) => t.canPut({
            toEl: i.el,
            fromEl: a.el,
            dragEl: l,
            newIndex: s,
    ...
    onMove: ({ from: i, dragged: a, to: l, related: s }) => {
      t.onDragMove && t.onDragMove({ fromEl: i, dragEl: a, toEl: l, relatedEl: s });
    },
    handle: o,
    filter: `${o}[disabled]`,
    onStart: ({ from: i, item: a, to: l, newDraggableIndex: s, oldDraggableIndex: u }) => {
      rt.active = !0, fn(), t.onDragStart({ fromEl: i, dragEl: a, toEl: l, newIndex: s, oldIndex: u });
    },
    onEnd: ({ from: i, item: a, to: l, newDraggableIndex: s, oldDraggableIndex: u }) => {
      rt.active = !1, dn(), t.onDragEnd({ fromEl: i, dragEl: a, toEl: l, newIndex: s, oldIndex: u });
    },
    onSort: ({ from: i, item: a, to: l, newDraggableIndex: s, oldDraggableIndex: u }) => {
      t.onDragSort({ fromEl: i, dragEl: a, toEl: l, newIndex: s, oldIndex: u });
    }
  });
}
function un(t) {

import { d as C, L as w, j as u, s as n, x as o, q as $, h as y } from "./iframe.js";
...
class M extends w {
  ...
  async setFocus() {
    await H(this), !this.disabled && this.interactive && this.containerEl?.focus();
  }
  updated() {
    E(this);
  }
  ...
  renderTile() {
    const { description: e, disabled: c, hasContentBottom: a, hasContentEnd: g, hasContentStart: f, hasContentTop: m, heading: l, icon: s, iconFlipRtl: x, interactive: i, selectionMode: h } = this, k = l && s && !e, v = !!this.href || !i, p = h === "multiple" && i ? "checkbox" : h !== "none" && i ? "radio" : i ? "button" : void 0, b = !!(e || g || f || l || s), z = !b && m && a;
    ...
    })} @click=${this.clickHandler} .role=${p} tabindex=${(v ? void 0 : 0) ?? $} ${S(this.setContainerEl)}>${this.renderSelectionIcon()}<div class=${n({
      [t.contentContainer]: !0,
      [t.contentContainerHasContent]: b,
  ...
  render() {
    ...
    return T({ disabled: e, children: this.href ? o`<calcite-link .disabled=${e} .href=${this.href}>${this.renderTile()}</calcite-link>` : this.renderTile() });
  }
}
y("calcite-tile", M);
export {

import { d, L as h, j as i, k as g, s as e, x as c, h as m } from "./iframe.js";
import { e as p, n as s } from "./ref.js";
import { k as a, s as f } from "./dom.js";
import { c as u, g as l } from "./component.js";
import { K as r } from "./resources3.js";
import { o as b } from "./openCloseComponent.js";
...
class x extends h {
  ...
  // #region Lifecycle
  async load() {
    this.requestedIcon = a(r, this.icon, this.kind);
  }
  willUpdate(t) {
    t.has("open") && (this.hasUpdated || this.open !== !1) && b(this), (t.has("icon") || t.has("kind") && (this.hasUpdated || this.kind !== "brand")) && (this.requestedIcon = a(r, this.icon, this.kind));
  }
  // #endregion
  ...
  // #region Rendering
  render() {
    const t = c`<button .ariaLabel=${this.messages.close} class=${e(o.close)} @click=${this.close} ${s(this.closeButton)}><calcite-icon icon=x .scale=${l(this.scale)}></calcite-icon></button>`;
    return c`<div class=${e(o.container)} ${s(this.setTransitionEl)}>${this.requestedIcon ? c`<div class=${e(o.icon)}><calcite-icon .flipRtl=${this.iconFlipRtl} .icon=${this.requestedIcon} .scale=${l(this.scale)}></calcite-icon></div>` : null}<div class=${e(o.content)}><slot name=${n.title}></slot><slot name=${n.message}></slot><slot name=${n.link}></slot></div><div class=${e(o.actionsEnd)} .hidden=${!this.hasActionEnd}><slot name=${n.actionsEnd} @slotchange=${this.handleActionsEndSlotChange}></slot></div>${this.closable ? t : null}</div>`;
  }
}
m("calcite-notice", x);
export {

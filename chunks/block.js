import { d as O, L as w, j as l, x as n, s as a, E as f, h as I } from "./iframe.js";
...
import { a as j } from "./floating-ui.js";
...
class q extends w {
  ...
  renderLoaderStatusIcon() {
    ...
    return e ? r("loader", n`<div class=${a(t.icon)}><calcite-loader inline .label=${o.loading}></calcite-loader></div>`) : i ? r("status-icon", n`<div class=${a(t.icon)}><calcite-icon class=${a({
      ...
      [t.valid]: i == "valid",
      [t.invalid]: i == "invalid"
    })} .icon=${u[i]} scale=s></calcite-icon></div>`) : r("icon-slot", n`<div class=${a(t.icon)} .hidden=${!this.hasIcon}>${r("icon-slot", n`<slot name=${h.icon} @slotchange=${this.iconSlotChangeHandler}></slot>`)}</div>`);
  }
  renderActionsEnd() {
  ...
  renderTitle() {
    ...
    return e || i ? n`<div class=${a(t.title)}>${L({ class: t.heading, level: o, children: e })}${i ? n`<div class=${a(t.description)}>${i}</div>` : null}</div>` : null;
  }
  renderIcon(e) {

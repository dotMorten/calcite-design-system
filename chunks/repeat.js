import { e as $, a as A, t as M, p as b, v as p, r as v, M as m, T as j, m as C } from "./iframe.js";
...
const w = (s, a, c) => {
  ...
  dt(s, a, c) {
    ...
    const e = [], i = [];
    let l = 0;
    for (const u of s) e[l] = h ? h(u, l) : l, i[l] = c(u, l), l++;
    return { values: i, keys: e };
  }
  render(s, a, c) {
    return this.dt(s, a, c).values;
  }
  update(s, [a, c, h]) {
    const e = b(s), { values: i, keys: l } = this.dt(a, c, h);

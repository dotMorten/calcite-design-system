import { d as a, L as i, j as o, k as l, s as n, x as r, h as c } from "./iframe.js";
...
class g extends i {
  ...
  // #region Rendering
  render() {
    return this.el.role = "radiogroup", r`<div aria-errormessage=${e.validationMessage} .ariaInvalid=${this.status === "invalid"} class=${n(p.itemWrapper)}><slot></slot></div>${this.validationMessage && this.status === "invalid" ? u({ icon: this.validationIcon, id: e.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status }) : null}`;
  }
}

import { b as c, m as K } from "./utils.js";
...
const {
  ...
  args: {
    ...
    dragEnabled: !1,
    filterEnabled: !1,
    interactionMode: V.values[0],
    label: "My List",
    loading: !1,
    scale: W.defaultValue,
    selectionAppearance: A.defaultValue,
    selectionMode: q.values[1],
    iconStart: "",
    iconEnd: ""
  },
  argTypes: {
    selectionMode: {
      options: q.values.filter((a) => a !== "children" && a !== "multichildren" && a !== "ancestors"),
      control: {
        type: "select"
      }
    },

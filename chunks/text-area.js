import { d as x, L as v, u as b, j as d, k as y, q as r, s, x as c, h as z } from "./iframe.js";
import { l as L } from "./live.js";
import { e as E, n as m } from "./ref.js";
import { c as $, d as w, H as k } from "./form.js";
import { c as A, d as O, g as S } from "./label.js";
import { s as g } from "./dom.js";
import { n as h } from "./locale.js";
import { c as C } from "./observers.js";
import { c as H } from "./component.js";
import { u as I, I as T } from "./interactive.js";
import { g as M } from "./guid.js";
import { V as W } from "./Validation.js";
import { s as F } from "./input.js";
import { u as j } from "./useT9n.js";
import { t as q } from "./throttle.js";
...
class N extends v {
  constructor() {
    ...
    }), this.setHeightAndWidthToAuto = q(() => {
    ...
    }, R, { leading: !1 }), this.disabled = !1, this.groupSeparator = !1, this.limitText = !1, this.messages = j({ blocking: !0 }), this.readOnly = !1, this.required = !1, this.resize = "both", this.scale = "m", this.status = "idle", this.validity = {
      valid: !1,
      badInput: !1,
      customError: !1,
      patternMismatch: !1,
  ...
  async setFocus() {
    await H(this), this.textAreaEl.focus();
  }
  // #endregion
  // #region Lifecycle
  connectedCallback() {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), O(this), w(this), this.resizeObserver?.disconnect();
  }
  // #endregion
  ...
  getHeightAndWidthOfElements() {
    const { height: e, width: t } = this.textAreaEl ? this.textAreaEl.getBoundingClientRect() : u, { height: i, width: l } = this.el.getBoundingClientRect(), { height: n, width: o } = this.footerEl.value ? this.footerEl.value.getBoundingClientRect() : u;
    return {
      textAreaHeight: e,
      textAreaWidth: t,
      elHeight: i,
  ...
  render() {
    ...
    return T({ disabled: this.disabled, children: c`<textarea aria-describedby=${this.guid ?? r} aria-errormessage=${f.validationMessage} .ariaInvalid=${this.status === "invalid" || this.isCharacterLimitExceeded()} .ariaLabel=${S(this)} .autofocus=${this.el.autofocus} class=${s({
      [a.textArea]: !0,

import { a as $, f as a, t as f, e as _, E as l } from "./iframe.js";
...
const c = /* @__PURE__ */ new WeakMap(), N = _(class extends Y {
  render(t) {
    return l;
  }
  update(t, [s]) {
  ...
  get lt() {
    return typeof this.Y == "function" ? c.get(this.ht ?? globalThis)?.get(this.Y) : this.Y?.value;
  }
  disconnected() {

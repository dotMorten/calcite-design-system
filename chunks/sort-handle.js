import { d as w, L as S, j as i, s as h, E as d, x as n, h as $ } from "./iframe.js";
...
class B extends S {
  constructor() {
    super(...arguments), this.disabled = !1, this.messages = y({ blocking: !0 }), this.moveToItems = [], this.open = !1, this.overlayPositioning = "absolute", this.placement = P, this.scale = "m", this.calciteSortHandleBeforeClose = i({ cancelable: !1 }), this.calciteSortHandleBeforeOpen = i({ cancelable: !1 }), this.calciteSortHandleClose = i({ cancelable: !1 }), this.calciteSortHandleMove = i({ cancelable: !1 }), this.calciteSortHandleOpen = i({ cancelable: !1 }), this.calciteSortHandleReorder = i({ cancelable: !1 });
  }
  static {

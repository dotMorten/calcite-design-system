import { d as E, L as w, j as r, o as b, s as c, x as H, h as k } from "./iframe.js";
...
class U extends w {
  ...
  render() {
    ...
    return this.el.inert = l, this.el.ariaLabel = t, this.el.ariaLive = "polite", b(this.el, "id", this.getId()), this.el.role = "tooltip", H`<div class=${c(f.positionContainer)} ${h(this.setFloatingEl)}><div class=${c({
      [u.animation]: !0,
      [u.animationActive]: s

...
function xt() {
  if (Or) return p;
  Or = 1;
  var I = Symbol.for("react.element"), l = Symbol.for("react.portal"), Te = Symbol.for("react.fragment"), ke = Symbol.for("react.strict_mode"), U = Symbol.for("react.profiler"), pe = Symbol.for("react.provider"), W = Symbol.for("react.context"), ee = Symbol.for("react.forward_ref"), re = Symbol.for("react.suspense"), te = Symbol.for("react.memo"), Y = Symbol.for("react.lazy"), F = Symbol.iterator;
  function z(t) {
  ...
  var q = ae.prototype = new ne();
  q.constructor = ae, $(q, x.prototype), q.isPureReactComponent = !0;
  ...
  function G(t, u, f, h, v) {
    ...
    if (S) return S = t, v = v(S), t = h === "" ? "." + ue(S, 0) : h, oe(v) ? (f = "", t != null && (f = t.replace(de, "$&/") + "/"), G(v, u, f, "", function(P) {
      return P;
    })) : v != null && (K(v) && (v = H(v, f + (!v.key || S && S.key === v.key ? "" : ("" + v.key).replace(de, "$&/") + "/") + t)), u.push(v)), 1;
  ...
  return p.Children = { map: Q, forEach: function(t, u, f) {
    ...
    return t;
  } }, p.Component = x, p.Fragment = Te, p.Profiler = U, p.PureComponent = ae, p.StrictMode = ke, p.Suspense = re, p.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = ve, p.act = ie, p.cloneElement = function(t, u, f) {
...
function Lt() {
  return Tr || (Tr = 1, function(I, l) {
    ...
    Te.NODE_ENV !== "production" && function() {
      ...
      var je = P.prototype = new b();
      je.constructor = P, f(je, v.prototype), je.isPureReactComponent = !0;
      function Pr() {
        var e = {
          current: null
        };
      ...
      function he(e) {
        if (Ir(e))
          return d("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Ar(e)), Ye(e);
      }
      function $r(e, r, n) {
        var a = e.displayName;
        if (a)
      ...
      function Lr(e, r, n) {
        ...
        if (r != null) {
          Ke(r) && (i = r.ref, xr(r)), Ge(r) && (he(r.key), s = "" + r.key), c = r.__self === void 0 ? null : r.__self, y = r.__source === void 0 ? null : r.__source;
          for (a in r)
        ...
        return Ie(e, s, i, c, y, A.current, o);
      }
      function Mr(e, r) {
      ...
      function $e(e, r) {
        return typeof e == "object" && e !== null && e.key != null ? (he(e.key), Ur("" + e.key)) : r.toString(36);
      }
      function me(e, r, n, a, o) {
        ...
        if (i) {
          var c = e, y = o(c), m = a === "" ? Qe + $e(c, 0) : a;
          if (ye(y)) {
            var E = "";
            m != null && (E = Je(m) + "/"), me(y, r, E, "", function(Dt) {
              return Dt;
            });
          } else y != null && (X(y) && (y.key && (!c || c.key !== y.key) && he(y.key), y = Mr(
            y,
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, o), o.default;
      ...
      function rr(e) {
        return !!(typeof e == "string" || typeof e == "function" || e === W || e === re || Q || e === ee || e === z || e === B || G || e === x || Pe || de || ue || typeof e == "object" && e !== null && (e.$$typeof === V || e.$$typeof === $ || e.$$typeof === te || e.$$typeof === Y || e.$$typeof === F || // This needs to include all possible module reference object
...
See https://reactjs.org/link/invalid-hook-call for tips about how to debug and fix this problem.`), e;
      ...
      var Fe = M.ReactCurrentDispatcher, xe;
      function ge(e, r, n) {
        {
          if (xe === void 0)
            try {
...
` + xe + e;
      ...
      function fr(e, r) {
        ...
        var s;
        s = Fe.current, Fe.current = null, vt();
        try {
          if (r) {
            var i = function() {
              throw Error();
...
` + c[m].replace(" at new ", " at ");
          ...
          Le = !1, Fe.current = s, yt(), Error.prepareStackTrace = o;
        }
...
Check the top-level render call using <` + n + ">.");
      ...
      function _r(e, r, n) {
        ...
        var c = Lr.apply(this, arguments);
        if (c == null)
          return c;
        if (a)
          for (var y = 2; y < arguments.length; y++)
            hr(arguments[y], e);
        return e === W ? Ct(c) : mr(c), c;
      }
      var gr = !1;
      function wt(e) {
      ...
      l.Children = At, l.Component = v, l.Fragment = W, l.Profiler = re, l.PureComponent = P, l.StrictMode = ee, l.Suspense = z, l.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = M, l.act = Rr, l.cloneElement = Pt, l.createContext = Hr, l.createElement = kt, l.createFactory = jt, l.createRef = Pr, l.forwardRef = Xr, l.isValidElement = X, l.lazy = Qr, l.memo = Jr, l.startTransition = Ot, l.unstable_act = Rr, l.useCallback = ut, l.useContext = Zr, l.useDebugValue = ct, l.useDeferredValue = lt, l.useEffect = nt, l.useId = pt, l.useImperativeHandle = st, l.useInsertionEffect = at, l.useLayoutEffect = ot, l.useMemo = it, l.useReducer = rt, l.useRef = tt, l.useState = et, l.useSyncExternalStore = dt, l.useTransition = ft, l.version = ke, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
  }(le, le.exports)), le.exports;
}
var kr;
function Mt() {
  if (kr) return Oe.exports;
  kr = 1;
  var I = {};
  return I.NODE_ENV === "production" ? Oe.exports = xt() : Oe.exports = Lt(), Oe.exports;
}
var Nt = Mt();
const Ut = /* @__PURE__ */ Ft(Nt);
export {
  Mt as a,
  Ut as e,
  Nt as r

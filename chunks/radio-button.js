import { d as u, L as f, j as s, s as b, E as p, x as m, h as k } from "./iframe.js";
...
class q extends f {
  ...
  render() {
    ...
    return R({ disabled: this.disabled, children: m`<div .ariaChecked=${this.checked} .ariaLabel=${A(this)} class=${b(L.container)} @blur=${this.onContainerBlur} @focus=${this.onContainerFocus} role=radio tabindex=${e ?? p} ${v(this.setContainerEl)}><div class="radio"></div></div>${w({ component: this })}` });
  }
}

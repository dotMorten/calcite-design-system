...
import { b as $, m as N } from "./utils.js";
...
const {
  ...
  args: {
    pageSize: 0,
    interactionMode: F.defaultValue,
    selectionMode: k.values[1],
  ...
  argTypes: {
    ...
    selectionMode: {
      options: k.values.filter((l) => l !== "children" && l !== "single-persist" && l !== "multichildren" && l !== "ancestors"),
      control: {
        type: "select"
      }
    },

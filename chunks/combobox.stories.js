...
v3.2.0-next.1 */
var B = Object.freeze, M = Object.defineProperty, O = (m, q) => B(M(m, "raw", { value: B(m.slice()) })), E;
function k(m, q) {
  const N = m(), {
    selectionMode: A
  } = q.args, _ = Array.isArray(A) ? A : [A], C = ["s", "m", "l"];
  return e`
    <style>
      calcite-combobox {
        margin-bottom: 250px;
        ...
        <div class="selection-mode-group">
          ${C.map((R) => e`
              <div class="combobox-container">
                <h3>${I} selection mode + ${R} scale</h3>
                <calcite-combobox
...
`, v = () => e` <calcite-combobox
  ...
  </calcite-combobox>`, h = () => e` <div style="width:400px;max-width:100%;background-color:white;padding:100px">
...
export {
  ...
  f as openWithPlaceholderIconInAllScales_TestOnly,
  ...
  i as smallViewport,
  T as validationMessageInAllScales_TestOnly,
  ...
  h as withoutPlaceholderIcon_TestOnly
};

import { d as s, L as r, s as a, x as i, h as c } from "./iframe.js";
...
class x extends r {
  ...
  handleActionBarSlotChange(e) {
    this.actionBar = d(e).filter((t) => t.matches("calcite-action-bar"))[0];
  }
  // #endregion
  // #region Rendering
  render() {
    const { actionBar: e } = this, t = i`<div class=${a(n.content)}><slot></slot></div>`, o = [l("action-bar", i`<div class=${a(n.actionBarContainer)} .hidden=${!this.actionBar}><slot name=${p.actionBar} @slotchange=${this.handleActionBarSlotChange}></slot></div>`), t];
    return e?.position === "end" && o.reverse(), o;
  }
}

import { d as c, L as a, j as t, s as o, q as i, C as l, c as n, x as r, h } from "./iframe.js";
import { e as d, n as g } from "./ref.js";
import { g as b } from "./dom.js";
import { c as u, d as p, H as k } from "./form.js";
...
class I extends a {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), y(this), p(this);
  }
  // #endregion
  ...
  render() {
    ...
    return f({ disabled: this.disabled, children: r`<div .ariaChecked=${this.checked} .ariaLabel=${C(this)} class=${o({
      [s.toggle]: !0,
      [l.rtl]: e
    })} @blur=${this.onToggleBlur} @focus=${this.onToggleFocus} role=checkbox tabindex=${(this.disabled ? void 0 : 0) ?? i} ${g(this.toggleEl)}><svg aria-hidden=true class=${o(s.check)} viewBox="0 0 16 16">${n`<path d=${this.getPath() ?? i} />`}</svg><slot></slot></div>${k({ component: this })}` });
  }
}

import { d as h, L as p, o as f, s as o, x as d, n as z, E as u, c as k, h as x } from "./iframe.js";
...
class w extends p {
  ...
  // #region Rendering
  render() {
    const { el: e, inline: r, label: l, text: n, type: i, value: v } = this, s = e.id || y(), a = i !== "indeterminate", c = Math.floor(v);

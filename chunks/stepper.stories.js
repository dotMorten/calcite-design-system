import { b as c, m as h } from "./utils.js";
...
const s = () => t` <calcite-stepper numbered style="width: 50vw">
  ...
  </calcite-stepper>`, l = () => t`<calcite-stepper>
  ...
  </calcite-stepper>`, a = () => t` <calcite-stepper numbered numbering-system="arab" lang="ar" dir="rtl" scale="s">
...
`, r = () => t`<calcite-stepper layout="vertical" scale="s" style="width: 1000px;">
      <calcite-stepper-item heading="Scale s" description="Add members without sending invitations"
        >Step 1 Content Goes Here</calcite-stepper-item
      >
    </calcite-stepper>
...
r.parameters = {
  ...
  docs: {
    ...r.parameters?.docs,
    source: {
      originalSource: `(): string => html\`<calcite-stepper layout="vertical" scale="s" style="width: 1000px;">
      <calcite-stepper-item heading="Scale s" description="Add members without sending invitations"
        >Step 1 Content Goes Here</calcite-stepper-item
      >
    </calcite-stepper>
...
const C = ["simple", "darkModeRTL_TestOnly", "overriddenWidth_TestOnly", "disabled_TestOnly", "arabicNumberingSystem_TestOnly", "verticalLayout_TestOnly", "horizontalSingleLayout_TestOnly", "verticalLayoutFullWidth"];
export {
  C as __namedExportsOrder,
  a as arabicNumberingSystem_TestOnly,

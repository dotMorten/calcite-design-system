import { s as g, x as s, d as b, L as f, j as y, k as $, q as r, n as k, h as w } from "./iframe.js";
...
class q extends f {
  ...
  // #region Lifecycle
  constructor() {
    super(), this.emit = !1, this.guid = `calcite-ratings-${F()}`, this.isKeyboardInteraction = !0, this.labelElements = [], this.max = 5, this._value = 0, this.disabled = !1, this.messages = K({ blocking: !0 }), this.readOnly = !1, this.required = !1, this.scale = "m", this.showChip = !1, this.status = "idle", this.validity = {
      valid: !1,
      badInput: !1,
      customError: !1,
      patternMismatch: !1,

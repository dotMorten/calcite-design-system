import { c as v, b as l, m as f } from "./utils.js";
...
const i = () => e`<div style="overflow: auto; width: 274px;">
  ...
  </div>`, n = () => e`<calcite-color-picker lang="ar"></calcite-color-picker>`, p = () => e`<calcite-color-picker lang="no"></calcite-color-picker>`, d = () => e`<calcite-color-picker lang="es"></calcite-color-picker>`, m = () => e`<calcite-color-picker lang="ja"></calcite-color-picker>`, k = () => e`<calcite-color-picker lang="ru"></calcite-color-picker>`, u = () => e`<calcite-color-picker lang="th"></calcite-color-picker>`, r = () => e(g || (g = O([`<calcite-color-picker value="#97a7b0"></calcite-color-picker>
    <script>
      (async () => {

...
>
  ...
  const [o, a] = Object.entries(t).filter(([c, i]) => c && i && i !== "").reduce(([c, i], [I, s]) => (c += `${I}="${s}" `, i += `${s} `, [c, i]), V);
...
`;
var C = Object.freeze, ve = Object.defineProperty, ke = (t, o) => C(ve(t, "raw", { value: C(t.slice()) })), g;
const fe = {
  calciteGraphHighlightFillColor: ""
}, we = e(g || (g = ke([`<div style="width:300px; height:100px">
...
}, Ie = e`<calcite-handle></calcite-handle>`, Be = e`<calcite-icon icon="3d-glasses"></calcite-icon>`, Se = {
...
}, De = e`<calcite-input-message status="invalid" icon="frown">Message</calcite-input-message>`, Le = e`<calcite-input-number
  placeholder="Placeholder text"
  prefix-text="prefix"
  suffix-text="suffix"
></calcite-input-number>`, Re = e`<calcite-input-text
  placeholder="Placeholder text"
  prefix-text="prefix"
  suffix-text="suffix"
></calcite-input-text>`, Fe = {
...
}, Ee = e` <calcite-link href="#" icon-start="banana" icon-end="information">link</calcite-link> `, _e = {
...
}, ze = e`<calcite-loader class="chromatic-ignore"></calcite-loader>`, Oe = {
...
}, Ue = e`<calcite-notice kind="success" scale="s" open closable>
...
}, Ve = e`<calcite-pagination
  total-items="1200"
  page-size="100"
  start-item="1"
></calcite-pagination>`, qe = {
...
}, ct = e`<calcite-rating></calcite-rating>`, ot = {
...
}, st = e`<calcite-text-area placeholder="testing" max-length="10"></calcite-text-area>`, dt = {
...
}, mt = e`<calcite-avatar full-name="Urbano Monti"></calcite-avatar>`, pt = e`<calcite-avatar user-id="umonti"></calcite-avatar>`, Ct = e`<calcite-avatar
...
`, ft = {
  ...
  </calcite-menu>`, It = e` ${T("horizontal")} ${T("vertical")} `, Bt = {
...
}, St = e`<calcite-combobox label="test" max-items="6" open>
...
</calcite-combobox>`, Pt = e`<calcite-combobox label="test" selection-mode="single">
  <calcite-combobox-item value="Trees" text-label="Trees"></calcite-combobox-item>
  <calcite-combobox-item value="Sequoia" disabled text-label="Sequoia"></calcite-combobox-item>
  <calcite-combobox-item value="Douglas Fir" text-label="Douglas Fir" selected></calcite-combobox-item>
</calcite-combobox>`, yt = e`<calcite-combobox label="test" placeholder-icon="layers">
  <calcite-combobox-item value="Trees" text-label="Trees"></calcite-combobox-item>
  <calcite-combobox-item value="Sequoia" disabled text-label="Sequoia"></calcite-combobox-item>
...
const w = (t, o = !1) => e`<div style="${Rt(t, o)}">
    <style>
      .demo {
        display: flex;
    ...
    <div class="demo">
      ...
      <div class="demo-column">
        ${lt} ${nt} ${Me} ${Ee} ${We} ${ze} ${K} ${pt} ${mt}
        ${Ct} ${Ze} ${Ie} ${we} ${st} ${Ye} ${kt} ${bt} ${ne}
        ${re}
      </div>
      <div class="demo-column">
        ${wt} ${ht} ${Tt} ${Q} ${j} ${ct} ${$t} ${Lt}
      </div>
      <div class="demo-column"><div class="demo-column">${M}</div></div>
      <div class="demo-column">${It}</div>
    </div>
    <div class="demo-row">
...
const Mt = ["themingInteractive", "theming"], Ot = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  __namedExportsOrder: Mt,
  default: Ft,
  theming: n,

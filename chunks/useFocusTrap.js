import { w as re, y as ie } from "./iframe.js";
  ...
  var o = i?.document || document, y = i?.trapStack || Te, c = Q({
    ...
    if (r.active)
      return X.activateTrap(y, h), r.delayInitialFocusTimer = c.delayInitialFocus ? Z(function() {
        F(k());
      }) : F(k()), o.addEventListener("focusin", H, !0), o.addEventListener("mousedown", L, {
        capture: !0,
        passive: !1
    ...
    if (r.active)
      return o.removeEventListener("focusin", H, !0), o.removeEventListener("mousedown", L, !0), o.removeEventListener("touchstart", L, !0), o.removeEventListener("click", z, !0), o.removeEventListener("keydown", q, !0), o.removeEventListener("keydown", Y), h;
  }, ne = function(t) {

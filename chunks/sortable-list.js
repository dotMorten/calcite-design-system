import { d as c, L as h, j as u, s as b, x as m, h as p } from "./iframe.js";
...
class E extends h {
  ...
  handleNudgeEvent(e) {
    const { direction: r } = e.detail, t = e.composedPath().find((a) => a.matches(this.handleSelector)), i = this.items.find((a) => a.contains(t) || e.composedPath().includes(a)), d = this.items.length - 1, s = this.items.indexOf(i);
    let o = !1, n;
    r === "up" ? s === 0 ? o = !0 : n = s - 1 : s === d ? n = 0 : s === d - 1 ? o = !0 : n = s + 2, this.endObserving(), o ? i.parentElement.appendChild(i) : i.parentElement.insertBefore(i, this.items[n]), this.items = Array.from(this.el.children), this.beginObserving(), requestAnimationFrame(() => S(t)), "selected" in t && (t.selected = !0);
  }
  setUpSorting() {

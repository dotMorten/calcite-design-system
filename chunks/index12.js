...
(function(r, o) {
  (function(a, l) {
    ...
    function X({ allowSquareBracketsOnAnyType: e, allowJsdocNamePaths: t, pathGrammar: n }) {
      return function(i, y, f) {
        if (f == null || y >= m.NAME_PATH)
          return null;
        const g = i.lexer.current.type, x = i.lexer.next.type;
        if (!(g === "." && x !== "<" || g === "[" && (e || f.type === "JsdocTypeName") || t && (g === "~" || g === "#")))
          return null;
        let O, z = !1;
    ...
    function v({ allowedAdditionalTokens: e }) {
      return J({
        name: "nameParslet",
    ...
    function ie({ allowNamedParameters: e, allowNoReturnType: t, allowWithoutParenthesis: n, allowNewAsFunctionKeyword: s }) {
      return J({
        ...
        parsePrefix: (i) => {
          ...
          const x = i.parseIntermediateType(m.FUNCTION);
          if (e === void 0)
            g.parameters = At(x);
          else {
    ...
    function pe({ allowSquaredProperties: e, allowKeyTypes: t, allowReadonly: n, allowOptional: s }) {
      return J({
        ...
        parseInfix: (i, y) => {
          var f;
          let g = !1, x = !1;
          s && y.type === "JsdocTypeNullable" && (g = !0, y = y.element), n && y.type === "JsdocTypeReadonlyProperty" && (x = !0, y = y.element);
    ...
    function Re() {
      return {
        ...
        JsdocTypeVariadic: (e, t) => e.meta.position === void 0 ? "..." : H(e.meta.position, t(e.element), "..."),
        ...
        JsdocTypeObjectField: (e, t) => {
          let n = "";
          return e.readonly && (n += "readonly "), typeof e.key == "string" ? n += A(e.key, e.meta.quote) : n += t(e.key), e.optional && (n += "?"), e.right === void 0 ? n : n + `: ${t(e.right)}`;
        },
    ...
    const Qt = {
      ...
      JsdocTypeName: (e) => e.value !== "function" ? R(e.value) : {
        type: "FunctionType",
        params: []
      },
      ...
      JsdocTypeSymbol: (e) => {
        ...
        return n?.type === "JsdocTypeVariadic" && (n.meta.position === "prefix" ? t = "..." : s = !0, n = n.element), n?.type === "JsdocTypeName" ? t += n.value : n?.type === "JsdocTypeNumber" && (t += n.value.toString()), s && (t += "..."), R(`${e.value}(${t})`);
      },
      JsdocTypeParenthesis: (e, t) => t(w(e.element)),
      JsdocTypeMappedType: k,
      JsdocTypeIndexSignature: k,
      JsdocTypeImport: k,
      JsdocTypeKeyof: k,
      JsdocTypeTuple: k,
      JsdocTypeTypeof: k,
      JsdocTypeIntersection: k,
      JsdocTypeProperty: k,
      JsdocTypePredicate: k,
      JsdocTypeAsserts: k
    };
    function Ht(e) {
      return q(Qt, e);
    ...
    a.catharsisTransform = Ht, a.identityTransformRules = tn, a.jtpTransform = en, a.parse = ve, a.stringify = Wt, a.stringifyRules = Re, a.transform = q, a.traverse = nn, a.tryParse = Yt, a.visitorKeys = _e;
  });
})(me, me.exports);
var fe = me.exports, on = Object.defineProperty, c = (r, o) => on(r, "name", { value: o, configurable: !0 });
const { UnknownArgTypesError: Rn } = __STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;
function sn(r, o) {
...
var Ln = /* @__PURE__ */ c((r) => {
  ...
  return p ? On(p, a) : a;
}, "enhanceArgTypes"), In = "storybook/docs", Fn = `${In}/snippet-rendered`, vn = /* @__PURE__ */ ((r) => (r.AUTO = "auto", r.CODE = "code", r.DYNAMIC = "dynamic", r))(vn || {});
export {
  Ln as c,
  vn as g,
  Fn as y

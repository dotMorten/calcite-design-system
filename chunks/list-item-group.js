import { d as s, L as l, j as n, s as e, x as c, h as o } from "./iframe.js";
...
class p extends l {
  constructor() {
    super(...arguments), this.disabled = !1, this.filterHidden = !1, this.scale = "m", this.calciteInternalListItemGroupDefaultSlotChange = n({ cancelable: !1 });
  }
  static {
  ...
  render() {
    ...
    return r({ disabled: t, children: c`<div class=${e(a.container)} role=row><div .ariaColSpan=${h} class=${e(a.heading)} role=cell>${i}</div></div><slot @slotchange=${this.handleDefaultSlotChange}></slot>` });
  }
}

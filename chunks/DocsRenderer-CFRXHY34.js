...
import { r as d, H as h, A as R, f as _, D as f } from "./index2.js";
...
var w = async (e, t, r) => {
  ...
  return o.render(a.createElement(g, { callback: c }, e)), u;
}, C = (e, t) => {
  let r = i.get(e);
  ...
  constructor() {
    this.render = async (e, t, r) => {
      ...
      return new Promise((c, E) => {
        import("./index3.js").then(({ MDXProvider: p }) => w(n.createElement(N, { showException: E, key: Math.random() }, n.createElement(p, { components: o }, n.createElement(u, { context: e, docsParameter: t }))), r)).then(() => c());
      });
    }, this.unmount = (e) => {
      C(e);
    };

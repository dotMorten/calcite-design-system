...
import { b as n, m as X } from "./utils.js";
import { h as e } from "./formatting.js";
import { A as ee } from "./resources14.js";
...
`, j = e`
  <calcite-action-bar class="calcite-mode-dark" slot="action-bar"> ${te} </calcite-action-bar>
`, Y = e`
  <calcite-action-bar slot="action-bar"> ${ce} </calcite-action-bar>
`, Q = e`
  ${j}
...
`, N = '<footer slot="footer">My Shell Footer</footer>', d = e(`
  <div
    style="
    width:100%;
    height:100%;
...
["float", "float-content"].forEach((t, a) => {
  U[a] = e(`<calcite-shell content-behind>
...
const y = () => I[0], f = () => I[1], k = () => e(`<calcite-shell content-behind>
  ${O}
  <calcite-shell-panel slot="panel-start">${Q}</calcite-shell-panel>
  ${d}
  <calcite-shell-center-row slot="center-row">${c}</calcite-shell-center-row>
  <calcite-shell-panel slot="panel-end">${J}</calcite-shell-panel>
  ${N}
...
["float", "float-content"].forEach((t, a) => {
  V[a] = e(`
    ...
    >
        ...
        background-size: 20px 20px;
        background-position: 0 0, 0 10px, 10px -10px, -10px 0px;"></div>
        <calcite-shell-panel slot="panel-bottom" display-mode="${t}" layout="horizontal">${ae}</calcite-shell-panel>
      </calcite-shell>
    `);
});
const C = () => V[0], S = () => V[1], L = () => e(`
  <calcite-shell
    style="
    width:100%;
    height:500px;
...
`), A = () => e(`<calcite-shell content-behind>
  ${O}
  <calcite-shell-panel slot="panel-start">${Q}</calcite-shell-panel>
  ${d}
  <calcite-shell-center-row slot="center-row">${ie}</calcite-shell-center-row>
  <calcite-shell-panel slot="panel-end">${J}</calcite-shell-panel>
  ${N}
...
const M = () => e`<calcite-shell>
  ...
  </calcite-shell>`, B = () => e`<calcite-shell>
    ...
    ></calcite-popover>`, H = () => e`<calcite-shell>
    <calcite-shell-panel slot="panel-start" position="start" id="shell-panel-start">
      <calcite-action-bar slot="action-bar">
  ...
  </calcite-shell>`, q = () => e` <calcite-shell content-behind>
    <div
      style="
      width:100%;
      height:100%;
  ...
  </calcite-shell>`, D = () => e` <calcite-shell content-behind>
    <div
      style="
      width:100%;
      height:100%;
...
export {
  ...
  S as contentBehindPanelBottomFloatContent,
  o as darkModeRTL_TestOnly,
  re as default,
  m as endPanelFloatContent_TestOnly,
  g as endPanelFloat_TestOnly,
  q as floatAllArrangements,
  D as floatAllArrangementsStart,
  p as overlayDisplayMode_TestOnly,
  M as panelEndWithPositionStart_TestOnly,
  z as panelTopFloatHorizontal_TestOnly,
  F as panelTopFloatVertical_TestOnly,
  $ as panelWithPopoverZIndex,
  H as popoverZIndex,
  r as resizableShellPanels,
  E as resizeHandlePositioning,
  A as shellCenterRowWithActionBar_TestOnly,
  B as shellPanelWithTabs,
  s as shellPanelZIndex_TestOnly,
  h as simple,
  x as slottedModalAndAlert,
  L as slottedPanelBottom_TestOnly,
  P as slottedPanelTopAndBottom,
  T as slottedPanelTopAndBottomAndSides,

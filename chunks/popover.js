import { d as P, L as k, j as n, s, x as h, o as C, h as A } from "./iframe.js";
...
import { F as T, f as H, t as R, q as B } from "./dom.js";
...
import { u as K } from "./useFocusTrap.js";
...
class X {
  constructor() {
    this.registeredElements = /* @__PURE__ */ new Map(), this.registeredElementCount = 0, this.queryPopover = (e) => {
      ...
      T(e) || e.defaultPrevented || this.togglePopovers(e);
    };
  }
  // --------------------------------------------------------------------------
  //
...
class J extends k {
  ...
  async setFocus() {
    await q(this), this.requestUpdate(), H(this.el);
  }

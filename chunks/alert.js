import { d as k, L as x, j as l, k as w, s as o, x as a, h as y } from "./iframe.js";
import { n as z } from "./ref.js";
import { i as m } from "./keyed.js";
import { f as T, s as A, k as $ } from "./dom.js";
import { c as E, g as p } from "./component.js";
import { N as F } from "./locale.js";
import { o as S } from "./openCloseComponent.js";
import { K as O } from "./resources3.js";
import { u as B } from "./useT9n.js";
import { D as c, S as r, C as s } from "./resources4.js";
...
class H extends x {
  ...
  static {
    this.properties = { hasEndActions: 16, isFocused: 16, numberStringFormatter: 16, active: 5, autoClose: 7, autoCloseDuration: 3, embedded: 5, icon: [3, { converter: w }], iconFlipRtl: 7, kind: 3, label: 1, messageOverrides: 0, numberingSystem: 3, open: 7, openAlertCount: 9, placement: 3, queue: 3, scale: 3 };
  }
  static {
    this.styles = D;
  }
  ...
  // #region Rendering
  render() {
    const { open: e, autoClose: t, label: i, placement: g, active: d, openAlertCount: b } = this, v = t ? "alert" : "alertdialog", u = !e, h = $(O, this.icon, this.kind), C = b > 1;
    return this.el.inert = u, this.el.ariaLabel = i, this.el.toggleAttribute("calcite-hydrated-hidden", u), this.el.role = v, a`<div class=${o({
      [s.container]: !0,
      [s.containerActive]: d,
      [`${s.container}--${g}`]: !0,
  ...
  renderCloseButton() {
    return m("close", a`<button .ariaLabel=${this.messages.close} class=${o(s.close)} @click=${this.closeAlert} @focusin=${this.autoClose ? this.handleKeyBoardFocus : null} @focusout=${this.autoClose ? this.handleKeyBoardBlur : null} type=button><calcite-icon icon=x .scale=${p(this.scale)}></calcite-icon></button>`);
  }
  renderQueueCount() {
  ...
  renderIcon(e) {
    return a`<div class=${o(s.icon)}><calcite-icon .flipRtl=${this.iconFlipRtl} .icon=${e} .scale=${p(this.scale)}></calcite-icon></div>`;
  }
}
y("calcite-alert", H);
export {

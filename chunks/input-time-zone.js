import { d as M, L as R, j as g, k, E as Z, x as v, s as V, h as _ } from "./iframe.js";
...
class fe extends R {
  constructor() {
    super(...arguments), this.clearable = !1, this.disabled = !1, this.maxItems = 0, this.messages = X({ blocking: !0 }), this.mode = "offset", this.offsetStyle = "user", this.open = !1, this.overlayPositioning = "absolute", this.readOnly = !1, this.required = !1, this.scale = "m", this.status = "idle", this.validity = {
      valid: !1,
      badInput: !1,
      customError: !1,
      patternMismatch: !1,
  ...
  renderRegionItems() {
    return this.timeZoneItems.flatMap(({ label: e, items: o }) => N(e, v`<calcite-combobox-item-group .label=${e}>${L(o, ({ label: s }) => s, (s) => {
      ...
      return v`<calcite-combobox-item data-label=${r ?? Z} .description=${f.country} .metadata=${f} .selected=${n} .textLabel=${r} .value=${y}><span class=${V(ee.offset)} slot=content-end>${f.offset}</span></calcite-combobox-item>`;
    })}</calcite-combobox-item-group>`));
  }
}
_("calcite-input-time-zone", fe);
export {
  fe as InputTimeZone
};
